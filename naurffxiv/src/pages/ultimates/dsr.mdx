...
- Blue defamation player stand 4 notches from relative NW.
- Divebomb marker goes opposite of the WAR.
- Lightnings behind the WAR, party in front of the WAR
...
![Static WB2 Positions Image](https://github.com/naurffxiv/assets/blob/main/Toolbox%20Resources/DSR/StaticWB2Positions2.0.png?raw=true)
### P7: The Dragon King
