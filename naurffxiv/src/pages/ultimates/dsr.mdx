...
- [NAUR - Detailed DSR Guide](hhttps://docs.google.com/document/d/1QHG3AFZ2yGZV5dgXmqvrz-F4wjsAroHTk-cnkuD32Iw/edit?usp=sharing)
...
### Waymarks
```json copy filename="Phase 1 NAUR"
{"Name":"DSR Phase 1","MapID":788,"A":{"X":93.331,"Y":0.0,"Z":103.162,"ID":0,"Active":true},
...
```json copy filename="NAUR DSR Markers"
