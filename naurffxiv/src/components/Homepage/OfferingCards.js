...
const divs = [
    { icon: icons.Contact, width: 70, height: 70, alt: "Person Search Icon", text: "Community", desc: "Inclusive & Helpful Community" },
    ...
    { iconMui: iconsMui.PersonSearchIcon, fontSize: "70px",alt: "Contact icon", text: "Recruitment Tools", desc: "Static & Party Finder Recruitment Tools" },
                            ...
                            <div key={div.alt} className="bg-[#007EA7] grid grid-rows-2 rounded-xl min-w-28 max-w-36 px-1 py-3 sm:pt-10 sm:pb-6 sm:px-3 sm:min-w-48 sm:max-w-48 flex-1">
                                {
                                    ...
                                    :
                                    <div.iconMui sx={{fontSize: div.fontSize}} className="m-auto"/>
                                }
