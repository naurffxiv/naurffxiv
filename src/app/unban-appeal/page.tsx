...
export default function UnbanAppeal(): ReactNode {
    ...
    <div className="w-full max-w-5xl ml-auto mr-auto px-4 py-8">
      <div className="flex flex-col gap-8">
        ...
        {showAppealForm && (
          <>
            <p>
              Some information about the form and the process that they will go
              through here but idrk what
            </p>
            ...
            <Button variant={"outlined"} onClick={onSubmitAppeal}>
              Submit Appeal
            </Button>
          </>
        )}
        ...
        {isAppealSubmitted && <div>Appeal submitted successfully</div>}
      </div>
    </div>
  );
  ...
  function onAppealExplanationChange(
