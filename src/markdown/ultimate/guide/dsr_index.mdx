...
- **Failing Mechanics**: Players who fail mechanics will be penalized with a Damage Down if they are not KO'd

<Callout type="tip"> 
In specific situations, intentionally accepting a KO can be more beneficial than continuing with Damage Down.
The Weakness debuff after revival often results in less DPS loss compared to the Damage Down penalty.
