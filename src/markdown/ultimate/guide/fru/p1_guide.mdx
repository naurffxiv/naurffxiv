...
<Buff b="damage-down" dur="2m" />, and all spreads and stacks inflict a <Buff b="magic-vuln" dur="2s" />.
...
If there are fewer than four players total hit by the attack, it will inflict <Buff b="mark-of-mortality" dur="2m" />.
