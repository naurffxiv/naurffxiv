...
After each major mechanic, **Thordan** performs **two separate sets** of auto attacks in quick 
succession. During each auto, he simultaneously targets three players:
...
- First auto: Melee DPS 1
- Second auto: Melee DPS 2

**After Akh Morn's Edge:**
- First auto: Ranged DPS 1
- Second auto: Ranged DPS 2

**After Gigaflare's Edge:**
- First auto: Healer 1
- Second auto: Healer 2
...
After Exaflare's Edge resolves, there will be two sets of auto attacks. The first auto should be baited by 
Melee 1, followed by the second auto baited by Melee 2.
...
After Akh Morn's Edge resolves, there will be two sets of auto attacks. The first auto should be baited by 
Ranged 1, followed by the second auto baited by Ranged 2.
...
After Gigaflare's Edge resolves, there will be two sets of auto attacks. The first auto should be baited by 
Healer 1, followed by the second auto baited by Healer 2.

## Phase Timeline & Enrage

The complete sequence of events:

1. **"Exaflare's Edge"** 1 → Two autos (Melee baits)
2. **"Akh Morn's Edge"** 1 → Two autos (Ranged baits)
3. **"Gigaflare's Edge"** 1 → Two autos (Healer baits)
4. **"Exaflare's Edge"** 2 → Two autos (Melee baits)
5. **"Akh Morn's Edge"** 2 → Two autos (Ranged baits)
6. **"Gigaflare's Edge"** 2 → Two autos (Healer baits)
7. **"Exaflare's Edge"** 3 → Two autos (Melee baits)
8. **"Akh Morn's Edge"** 3 → Two autos (Ranged baits)
