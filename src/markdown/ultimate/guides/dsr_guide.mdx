...
This guide follows the [P1 Toolbox](https://ff14.toolboxgaming.space/?id=802461081524561&preview=1#1) 
from the DSR resource page.
...
The start of Phase 2 follows the 
...
The second part of "**Sanctity of the Ward**" follows the 
...
**"Final Chorus"**, from **Nidhogg** as he descends. He will begin auto-attacking the main tank three times 
with cleaving line AoEs. The tank should face the boss north at the A marker. **Nidhogg** will then cast 
