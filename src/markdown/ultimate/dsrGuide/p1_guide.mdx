...
they will explode and deal damage to the party. This will also apply a <Buff b="damage-down" type="json" />
...
Tanks can survive but receive a <Buff b="damage-down" type="json" />.
</Callout>
...
Move to the middle of the arena and prepare to be chained and marked.
...
- **Tank**: North position
- **Healer**: South position

#### Green Triangle Positions

- **DPS**: Northwest position
- **Healer**: Southeast position

#### Purple Square Positions

- **Tank**: Northeast position
- **DPS**: Southwest position

#### Red Circle Positions

- **DPS (Furthest Marker West)**: West position
- **DPS (Furthest Marker East)**: East position

![Playstation Markers](/images/dsrGuide/p1/playstation.png)

The diagram above shows the arena with all marker positions.
Remember: Your position is determined by both your role (Tank, Healer, or DPS) AND your assigned PlayStation marker.

### Breaking Chains

Once in your assigned position, prepare for the knockback from **Ser Grinnaux**.
